...
<div class="container">
    <div class="row">
        <div class = "col-md-10">
            <h2>Aprovação de Atividade de Complementar de Graduação</h2>
        </div>
    </div>
    <div class="container">
        <div class="row">
                        ...
                        <div class="col-md-6">
                            <fieldset>
                                <ul class="list-group">
                                    ...
                                    <li><h4 class="subheader"><?= __('Horas Aprovadas:'); ?></h4></li>
                                    <li class="list-group-item"><?= h($avaliation->activity->activity_hours) ?></li>
                                    <li><h4 class="subheader"><?= __('Observações do Colegiado:') ?></h4></li>
                                    <li class="list-group-item"><?= h($avaliation->observation) ?></li>
                                    <li><h4 class="subheader"><?= __('Data do Parecer:') ?></h4></li>
                                    <li class="list-group-item"><?= h(date_format($avaliation->date, 'd/m/Y')) ?></li>
                                </ul>
                                <br>
                                <div class="btn-group col-md-12" data-toggle="buttons">
                                    <label class="btn btn-success col-md-6">
                                        <input type="radio" name="situation" value="2" required="required"><strong>Deferir</strong>
                                    </label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12" style="margin-top: 10px;">
                                    <?= $this->Html->Link(__('Cancelar'), array('controller' => 'Activities', 'action' => 'alunoList'), ['class' => 'btn btn-default col-md-12']); ?>
                                </div>
                            </div>
                            <?= $this->Form->end() ?>
                        </div>
