...
class ActivitiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'submition_date' => ['type' => 'date', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            'fk_activities_users1_idx' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
